...
export default function ClienteNfePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background p-6 space-y-6 pb-32">
      ...
      <div className="space-y-6">
        ...
        <div>
          <h1 className="text-3xl font-black font-display tracking-tighter text-foreground leading-tight">Escolha o <br/> <span className="text-primary italic">Destinatário.</span></h1>
        ...
        <div className="space-y-4">
          {clientesFiltrados.map((cliente) => (
            ...
            >
              ...
              <div className="flex items-start gap-4">
                <div className={`h-12 w-12 rounded-2xl flex items-center justify-center shrink-0 font-black text-sm ${cliente.tipo === 'PJ' ? 'bg-blue-500/10 text-blue-500' : 'bg-emerald-500/10 text-emerald-500'}`}>
                ...
                <div className="min-w-0 pr-4">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className={`text-[8px] font-black px-1.5 py-0.5 rounded-md uppercase tracking-tighter ${cliente.tipo === 'PJ' ? 'bg-blue-500/10 text-blue-500' : 'bg-emerald-500/10 text-emerald-500'}`}>
                      {cliente.tipo}
                    </span>
                  </div>
          ...
          {clientesFiltrados.length === 0 && (
            <div className="text-center py-24 bg-card rounded-[2.5rem] border-2 border-dashed border-border/40">
               ...
               <p className="text-sm font-bold text-muted-foreground px-12 leading-relaxed">Nenhum cliente encontrado para sua busca.</p>
